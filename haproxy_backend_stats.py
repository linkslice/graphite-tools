...
def main():
    ...
    parser.add_option('-b', '--backend', dest='backend',
        action='append',
        help='list of backends to fetch, if not specified will fetch entire list')
    ...
    #party time
    package, currentTime, result = fetchOID(options.host, options.community, options.graphiteroot, options.backend, options.verbose)
