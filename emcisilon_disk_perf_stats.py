...
def main():
    ...
    parser.add_option('-b', '--emcDisk', dest='emcDisk',
        action='append',
        help='list of emcDisks to fetch, if not specified will fetch entire list')
    ...
    #party time
    package, currentTime, result = fetchOID(options.host, options.community, options.graphiteroot, options.emcDisk, options.verbose)
