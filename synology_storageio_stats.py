...
def fetchOID(host, community, graphiteroot, diskio, verbose):
    ...
    statsTable = {
        'storageIONRead': '1.3.6.1.4.1.6574.101.1.1.3',
        'storageIONWritten': '1.3.6.1.4.1.6574.101.1.1.4',
        'storageIOReads': '1.3.6.1.4.1.6574.101.1.1.5',
        'storageIOWrites': '1.3.6.1.4.1.6574.101.1.1.6',
        'storageIOLA': '1.3.6.1.4.1.6574.101.1.1.8',
        'storageIOLA1': '1.3.6.1.4.1.6574.101.1.1.9',
        'storageIOLA5': '1.3.6.1.4.1.6574.101.1.1.10',
        'storageIOLA15': '1.3.6.1.4.1.6574.101.1.1.11',
        'storageIONReadX': '1.3.6.1.4.1.6574.101.1.1.12',
        'storageIONWrittenX': '1.3.6.1.4.1.6574.101.1.1.13'
        }
    snmp = netsnmp.Session(DestHost=host, Version=2, Community=community)
    
    # connect and fetch the list of virtual servers
    synologyStorageIOList = '.1.3.6.1.4.1.6574.101.1.1.2'
    Var = netsnmp.Varbind(synologyStorageIOList)
