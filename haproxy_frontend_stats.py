...
def fetchOID(host, community, graphiteroot, frontend, verbose):

    if verbose:
        print >> sys.stderr, 'connecting to host: %s using community: %s' % ( host, community )

    statsTable = {
        'bytesIn': '1.3.6.1.4.1.29385.106.1.0.8',
        'bytesOut': '1.3.6.1.4.1.29385.106.1.0.9',
        'hsrp_1xx': '1.3.6.1.4.1.29385.106.1.0.39',
        'hsrp_2xx': '1.3.6.1.4.1.29385.106.1.0.40',
        'hsrp_3xx': '1.3.6.1.4.1.29385.106.1.0.41',
        'hsrp_4xx': '1.3.6.1.4.1.29385.106.1.0.42',
        'hsrp_5xx': '1.3.6.1.4.1.29385.106.1.0.43',
        'hsrp_other': '1.3.6.1.4.1.29385.106.1.0.44',
        'responseErrors': '1.3.6.1.4.1.29385.106.1.0.14',
        'sessionCurrent': '1.3.6.1.4.1.29385.106.1.0.4',
        'sessionLimit': '1.3.6.1.4.1.29385.106.1.0.6',
        'sessionMax': '1.3.6.1.4.1.29385.106.1.0.5',
        'totalSessions': '1.3.6.1.4.1.29385.106.1.0.7'
        }
    snmp = netsnmp.Session(DestHost=host, Version=2, Community=community)
    
    # connect and fetch the list of virtual servers
    frontendList = '.1.3.6.1.4.1.29385.106.1.0.0'
    Var = netsnmp.Varbind(frontendList)
...
def main():
    ...
    parser.add_option('-b', '--frontend', dest='frontend',
        action='append',
        help='list of frontends to fetch, if not specified will fetch entire list')
    ...
    #party time
    package, currentTime, result = fetchOID(options.host, options.community, options.graphiteroot, options.frontend, options.verbose)
