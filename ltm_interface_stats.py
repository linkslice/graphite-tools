...
def main():
    ...
    parser.add_option('-s', '--interface', dest='interface',
        action='append',
    ...
    #party time
    package, currentTime, result = fetchOID(options.host, options.community, options.graphiteroot, options.interface, options.verbose)
